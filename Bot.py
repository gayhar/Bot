...
SPAM_LIMIT = 10
SPAM_TIME_WINDOW = 10
SPAM_BAN_DURATION = 3600

# ================== مسیرهای ذخیره‌سازی ==================
# تنظیم مسیرها برای Railway
BASE_DIR = os.getcwd()

if 'RAILWAY_STATIC_URL' in os.environ:
    # روی Railway - استفاده از مسیر موقت
    DATA_DIR = '/tmp/bot_data'
    QUESTIONS_DIR = BASE_DIR  # فایل‌های سوالات در مسیر اصلی
else:
    # روی لوکال
...
print(f"📁 مسیر سوالات: {QUESTIONS_DIR}")
...
class DataManager:
    ...
    def save_data(self, data, file_path):
        try:
            # برای Railway از روش امن استفاده می‌کنیم
